...
Состояние записано как (q0: {0,1,6,14}), где q0 - название состояния в ДКА, а {0,1,6,14} - состояния из НКА
![Рис. 2. Получившийся ДКА](img/dfa.png)

## Минимальный ДКА
Состояние записано как (p0: {q12,q24}), где p0 - название состояния в мин. ДКА, а {q12,q24} - состояния из ДКА
