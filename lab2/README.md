...
Состояние записано как (q0: {0,1,6,14}), где q0 - название состояние в ДКА, а {0,1,6,14} - состояния из НКА
![Рис. 2. Получившийся ДКА](img/dka.png)

## Минимальный ДКА
Получившийся минимальный ДКА лежит в файле min_dka.dot:
Состояние записано как (p0: {q12,q24}), где p0 - название состояние в мин. ДКА, а {q12,q24} - состояния из ДКА
